...
export class AIService {
  ...
  async complete(request: AICompletionRequest): Promise<AICompletionResponse> {
    ...
    switch (config.provider) {
      case 'gemini':
        return this.completeGemini(config, request);
      case 'anthropic':
        return this.completeAnthropic(config, request);
      case 'openai':
        return this.completeOpenAI(config, request);
      case 'ollama':
        return this.completeOllama(config, request);
      default:
